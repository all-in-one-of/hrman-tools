...
#       416-504-9876
#
# NAME: HoudiniLight_RIB.py ( Python )
#
# COMMENTS:     Wrangler for the HoudiniLight object.  This wrangler
#               defines wranglers for several renderers.
#
...
# Here, we define methods for each of the properties on RIB light
# sources.
...
def light_shader(obj, now, value):
    ...
    if render_domaxdist == 1:
        shader += ' %s [%g]' % (_uf('render_domaxdist'), render_domaxdist)
